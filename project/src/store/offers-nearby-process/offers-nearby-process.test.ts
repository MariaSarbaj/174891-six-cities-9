...
describe('Reducer: offersNearbyProcess', () => {
  ...
  it('should update favorites-page by set offers nearby', () => {
  ...
  it('should update favorites-page by replace offer nearby', () => {
  ...
  it('should update favorites-page by set room data', () => {
    const state = [] as Offer[];
